  ...
  <div class="card">
    <div class="card-body register-card-body">
      ...
      <form action="insert.php" method="post">
        ...
        <div class="input-group mb-3">
          <input type="password" name="txt_repassword" class="form-control" placeholder="ยืนยันรหัสผ่านอีกครั้ง">
          <div class="input-group-append">
            <div class="input-group-text">
              <span class="fas fa-lock"></span>
            </div>
        ...
        <div class="row">
          ...
          <!-- /.col -->
          <div class="col-4">
            <button type="submit" class="btn btn-primary btn-danger">ละทะเบียน</button>
          </div>
          <!-- /.col -->
        </div>
      </form>
